...
export interface ApiAboutCeoAboutCeo extends Struct.SingleTypeSchema {
  collectionName: 'about_ceos';
  info: {
    description: 'CEO page content';
    displayName: 'About CEO';
    pluralName: 'about-ceos';
    singularName: 'about-ceo';
  };
  options: {
...
export interface ApiAboutHistoryAboutHistory extends Struct.SingleTypeSchema {
  collectionName: 'about_histories';
  info: {
    description: 'Company history page header';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logoWordmark: Schema.Attribute.Media<'images'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    siteName: Schema.Attribute.String & Schema.Attribute.DefaultTo<'AIAN'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTimelineItemTimelineItem
  ...
  info: {
    description: 'Company history timeline entry';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-ceo.about-ceo': ApiAboutCeoAboutCeo;
